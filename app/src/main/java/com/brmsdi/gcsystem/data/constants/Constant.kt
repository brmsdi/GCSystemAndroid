...
class Constant private constructor() {
    ...
    object API {
        ...
        const val BASE_URL = "https://gcsystemws.onrender.com/"
    ...
    object ENDPOINT {
        ...
        const val REPAIR_REQUEST_ITEM = "$DEFAULT_API/repair-requests/item"
        ...
        const val ORDER_SERVICE_CLOSE = "$DEFAULT_API/order-services/order-service/close"
    }

...
interface LoginService {
    ...
    @POST(LOGIN_LESSEES)
    fun loginLessee(@Query("username") username : String, @Query("password") password : String) : Call<Token>

    @POST(LOGIN_EMPLOYEES)
    fun loginEmployee(@Query("username") username : String, @Query("password") password : String) : Call<Token>
}